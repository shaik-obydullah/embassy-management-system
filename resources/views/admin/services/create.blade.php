...
<div class="bg-white rounded-lg shadow p-6 max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Create New Service</h1>
    ...
    <form method="POST" action="{{ route('admin.services.store') }}">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" rows="4"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
            @error('description')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="number" step="0.01" name="fee" id="fee" value="{{ old('fee', '0.00') }}" required
            ...
            <div>
                ...
                <select name="category" id="category" required
                    ...
                    <option value="consular" {{ old('category') === 'consular' ? 'selected' : '' }}>Consular</option>
        ...
        <div class="mb-4">
            ...
            <textarea name="required_documents" id="required_documents" rows="3"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500 focus:border-green-500 @error('required_documents') border-red-500 @enderror">{{ old('required_documents') }}</textarea>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="number" name="estimated_days" id="estimated_days" value="{{ old('estimated_days', '7') }}"
